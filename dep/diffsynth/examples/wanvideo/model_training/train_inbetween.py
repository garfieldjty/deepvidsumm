...
class WanTrainingModuleInBetween(DiffusionTrainingModule):
    def __init__(
        self,
        ...
        self.pipe.model_fn = model_fn_longcat_video_inbetween
    ...
    def forward_preprocess(self, data):
        ...
        longcat_start_video = video_frames[:self.num_start_frames]
        longcat_end_video = video_frames[-self.num_end_frames:]
...
if __name__ == "__main__":
    ...
    model = WanTrainingModuleInBetween(
